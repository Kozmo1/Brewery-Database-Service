        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasteProfile_PrimaryFlavor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TasteProfile_Sweetness = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TasteProfile_Bitterness = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cart", x => new { x.UserId, x.InventoryId });
                });
